        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              while ($row = mysqli_fetch_assoc($select_from_categories_query)) {
                  ...
                  echo "<li><a href='category_sub.php?category=$cat_id'>{$cat_title}</a></li>";
              }

               ?>
                <li>
                    <a href="subscriber" align = "left">Profile</a>
                </li>

                <li>

                  <a href="includes_subscriber/logout.php" align = "left">Logout</a>
