...
if (isset($_POST['create_post'])) {
  ...
  if (!empty($post_title) && !empty($post_author) && !empty($post_category_id) && !empty($post_image) && !empty($post_image_temp) && !empty($post_tags) && !empty($post_content)) {
            ...
            $message = "Post Created</strong>: <a href='../post_sub.php?p_id={$the_post_id}'>View Post</a>";
            $result = "success";
  }
